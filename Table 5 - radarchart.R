...
data <- rbind(rep(2,1) , rep(0,1) , data)
data
...
radarchart( data  , axistype=1 , 
            ...
            #custom the grid
            cglcol="grey", cglty=1, axislabcol="grey", caxislabels=seq(0,2,1), cglwd=0.8,
            #custom labels
            vlcex=0.8 
)
...
png(filename = "radarchart figure5.png", width=900, height=500, unit="px", bg="transparent")
radarchart( data  , axistype=1 , 
            #custom polygon
            pcol=colors_border , pfcol=colors_in , plwd=4 , plty=1,
            #custom the grid
